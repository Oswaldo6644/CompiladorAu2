...
public class Interfaz extends javax.swing.JFrame {
    ...
    File ubicacion = new File("C:\\Users\\Martha\\Desktop\\Compilador_v2-master\\src\\compiladorv2\\archivos");
    ...
    //Métodos agregados
    public void Vaciar() {
        ubicacion = new File("C:\\Users\\Martha\\Desktop\\Compilador_v2-master\\src\\compiladorv2\\archivos");
        errores = null;
...
//*****************************************************************
    ...
    public void CargarTabla() {
         ...
         */
        try (BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\Martha\\Documents\\Automatas 2\\Tabla de análisis sintáctico.csv"))) {
    ...
    public boolean Evaluar(List<Token> expresion)
    {
        ...
        */
        int [][] autop =    { { 0, 0, 0, 0, 0, 0}, 
                              { 2, 0, 1, 1, 1, 1},
                              { 0, 0, 1, 1, 1, 1}, // Paréntesis de apertura '('
                              { 0, 0, 1, 1, 1, 1}, // Paréntesis de cierre ')'
                              { 0, 0, 0, 0, 1, 1}, // Operador suma/resta ('+', '-')
                              { 0, 0, 0, 0, 1, 1} }; // Operador multiplicación/división ('*', '/')
        
        //Autómata para manejar las operaciones
        int [][] autot =    { {  0,  1, -1}, // Operando 1 es entero
                              {  1,  1, -1}, // Operando 1 es flotante
                              { -1, -1, -1} }; // Operando 1 es no compatible
              ...
              case 12:
                  ...
                  else
                  {
                      ...
                      while(aux)
                      {
                          ...
                          ap[1] = c.indexOf(pilao.peek().Lexema()); // Operador en la pila
                          ap[0] = c.indexOf(t.Lexema());            // Operador entrante
                          switch(autop[ap[0]][ap[1]])
                          {
                              case 0: //Metemos a la pila
                                  pilao.push(t); // Colocar en la pila
                                  aux= false;
                                  break;
                              case 1: //Sacamos
                                  evaluar.add(pilao.pop()); // Compatibilidad de tipos
        ...
        for(Token t : evaluar)
        {
            switch(t.Tipo())
            {
                ...
                default: //Osea que debe ser un operador
                    ...
                    var2 = pilae.pop();
                    var1 = pilae.pop();
                    vart = autot[var2][var1]; // Compatibilidad de tipos
   ...
   ~~~~  */
    ...
    private void initComponents() {
        ...
        btn_correr.setBackground(new java.awt.Color(0, 153, 51));
        ...
        Area_Sintactico.setBackground(new java.awt.Color(153, 153, 153));
        ...
        Area_Lexico.setBackground(new java.awt.Color(153, 153, 153));
